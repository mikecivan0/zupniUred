...
$izraz = $veza->prepare("select distinct concat(o.ime,' ',o.prezime) as imeIPrezime,o.spol,o.jmbg,mk.datumKrizme as datumPotvrde,mk.datumPricesti,
						 mk.otac,mk.majka,mk.mjestoKrstenja,mk.datumKrstenja,mk.datumRodjenja,
						 mk.mjestoRodjenja,mk.id as mkId,z.nazivZupe from osobe o
...
foreach ($osobe as $osoba) {
	...
	$osoba->mjestoKrstenja = ($osoba->mjestoKrstenja!=null) ? $osoba->mjestoKrstenja : 'nepoznato';					 
	...
	$osoba->datumPricesti = ($osoba->datumPricesti!=null&&$osoba->datumPricesti!='0000-00-00') ?  explode("-",$osoba->datumPricesti)[2] . "." . explode("-",$osoba->datumPricesti)[1] . ".". explode("-",$osoba->datumPricesti)[0] . "." : null;
}
