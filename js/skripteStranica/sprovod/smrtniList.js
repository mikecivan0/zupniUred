...
$(function(){		
	$("#printP").children().click(function(){
	   $("#smrtniList").attr('action', '../../printanje/sprovod/smrtniList.php?vrstaDokumenta=14');
	   $('#smrtniList').submit();
	});		
	
	$("#previewP").children().click(function(){
	   $('#smrtniList').attr('action', '../../printanje/sprovod/smrtniList.php?preview=true&vrstaDokumenta=14');
	   $('#smrtniList').submit();
	});		
	...
	$("#zapis").autocomplete({
			    ...
			    select: function(event, ui) {
			          ...
			          $('#prebivaliste').val(ui.item.mjestoPrebivanja + ", " + ui.item.ulica + " " + ui.item.kucniBroj);
