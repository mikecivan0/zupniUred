...
$title = 'Molba za mješovitu ženidbu';
$legend = 'Molba za mješovitu ženidbu';
$formId = 'molbaZaMjesovituZenidbu';
$postURL = $putanjaApp . 'printanje/vjencanje/molbaZaMjesovituZenidbu.php?vrstaDokumenta=8';
...
if($_POST&&isset($_GET["katolik"])){
	include_once '../../klase/formulari/molbaZaMjesovituZenidbu.php';
	MolbaZaMjesovituZenidbu::ConvertPost($_GET["katolik"]);
}
?>
<div class="row mb40">
...
<div class="row">
	...
	<div class="large-6 columns end">
		<?php Html::Input('Ime i prezime zaručnika', 'text', 'imeIPrezimeOn', 'imeIPrezimeOn') ?>
	</div>
	<div class="large-6 columns">
		<?php Html::Input('Vjera zaručnika', 'text', 'vjeraOn', 'vjeraOn') ?>
	</div>
	<div class="large-6 columns">
		<?php Html::Input('Ime i prezime zaručnice', 'text', 'imeIPrezimeOna', 'imeIPrezimeOna') ?>
	</div>
	<div class="large-6 columns">
		<?php Html::Input('Vjera zaručnice', 'text', 'vjeraOna', 'vjeraOna')
		?>
	</div>
...
$footerScript = $footerScript . '<script src="' . $putanjaApp . 'js/skripteStranica/vjencanje/molbaZaMjesovituZenidbu.js"></script>';
